...
export default function LearningDashboard() {
  ...
  const dnaQuestions = [
    ...
    // NEW QUESTION 16: Learning Speed
    {
      ...
      question: 'How quickly do you typically grasp new concepts?',
      options: [
        { 
          id: 'very_fast', 
          text: 'Very fast - I understand quickly with minimal repetition', 
          icon: '⚡', 
          description: 'Fast learner who needs minimal review'
        },
        { 
          id: 'fast', 
          text: 'Fast - I understand with some review needed', 
          icon: '🚀', 
          description: 'Quick understanding with some reinforcement'
        },
        { 
          id: 'average', 
          text: 'Average - I need normal pace with examples', 
          icon: '📊', 
          description: 'Steady learning pace works best'
        },
        { 
          id: 'slow', 
          text: 'Slow - I need detailed explanations and repetition', 
          icon: '🐢', 
          description: 'Prefer thorough explanations with practice'
        },
        { 
          id: 'very_slow', 
          text: 'Very slow - I need multiple sessions to understand', 
          icon: '⏳', 
          description: 'Benefit from breaking concepts into small parts'
        }
      ]
    },
    // NEW QUESTION 17: Daily Learning Time
    {
      ...
      options: [
        { 
          ...
          icon: '⏱️', 
          description: 'Short daily sessions work best'
        },
        { 
          id: '1_hour', 
          text: '30-60 minutes', 
          icon: '🕐', 
          description: 'About an hour per day'
        },
        { 
          id: '2_hours', 
          text: '1-2 hours', 
          icon: '🕑', 
          description: 'Can dedicate 1-2 hours daily'
        },
        { 
          id: '3_hours', 
          text: '2-3 hours', 
          icon: '🕒', 
          description: '2-3 hours available for learning'
        },
        { 
          id: 'more_3_hours', 
          text: 'More than 3 hours', 
          icon: '📚', 
          description: 'Extended learning sessions possible'
        }
      ]
    },
    // NEW QUESTION 18: Difficulty Handling
    {
      ...
      category: 'Learning Capacity',
      question: 'When you encounter a difficult concept, you usually:',
      options: [
        { 
          id: 'persist_until_master', 
          text: 'Keep trying until you master it', 
          icon: '💪', 
          description: 'Highly persistent with challenges'
        },
        { 
          id: 'break_and_return', 
          text: 'Take breaks but come back to it', 
          icon: '⏸️', 
          description: 'Strategic breaks help understanding'
        },
        { 
          id: 'alternative_explanations', 
          text: 'Look for alternative explanations', 
          icon: '🔍', 
          description: 'Seek different perspectives'
        },
        { 
          id: 'ask_for_help', 
        ...
        { 
          id: 'skip_and_move', 
          text: 'Skip it and move on for now', 
          icon: '➡️', 
          description: 'Prefer to revisit later'
        }
      ]
    },
    // NEW QUESTION 19: Revision Needs
    {
      ...
      options: [
        { 
          id: 'rarely', 
          text: 'Rarely - once is enough', 
          icon: '🎯', 
          description: 'Excellent long-term retention'
        },
        { 
          id: 'occasionally', 
          text: 'Occasionally - some review helps', 
          icon: '📝', 
          description: 'Occasional review improves recall'
        },
        { 
          id: 'regularly', 
          text: 'Regularly - need periodic review', 
          icon: '🔄', 
          description: 'Regular spaced repetition needed'
        },
        { 
          id: 'frequently', 
          text: 'Frequently - need constant review', 
          icon: '📖', 
          description: 'Frequent reinforcement required'
        },
        { 
          id: 'always', 
          text: 'Always - need multiple reviews to retain', 
          icon: '🧠', 
          description: 'Multiple reviews essential for memory'
        }
      ]
    },
    // NEW QUESTION 20: Application Speed
    {
      id: 'applicationSpeed',
      category: 'Learning Capacity',
      question: 'How quickly can you apply new knowledge to real situations?',
      options: [
        { 
          id: 'immediately', 
          text: 'Immediately - I can apply right away', 
          icon: '⚡', 
          description: 'Quick practical application'
        },
        { 
          id: 'quickly', 
          text: 'Quickly - after some practice', 
          icon: '🚀', 
          description: 'Fast application with practice'
        },
        { 
          id: 'moderate', 
          text: 'Moderate pace - need examples first', 
          icon: '📊', 
          description: 'Need examples before applying'
        },
        { 
          id: 'slowly', 
          text: 'Slowly - need to fully understand first', 
          icon: '🐢', 
          description: 'Thorough understanding before application'
        },
        { 
          id: 'gradually', 
          text: 'Gradually - apply in small steps', 
          icon: '🪜', 
          description: 'Step-by-step application works best'
        }
      ]
    }
  ]
